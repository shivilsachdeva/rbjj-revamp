    ...
    <footer className={styles.footer}>
      <div className={styles.wrap}>
        ...
        <div className={styles.col}>
          ...
          <a href="https://instagram.com/radjibarrettjiujitsu" target="_blank" rel="noreferrer" aria-label="Instagram" className={styles.socialIcon}>
